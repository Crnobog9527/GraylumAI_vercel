      ...
      if(opcMode){
        ...
        try{
          ...
          if(brief==='topic:first-week') {
            ...
            const rows=[{id:'aaaaaaaa-1111-4111-8111-111111111111',platform:'x',account:'existing-account',title:revision?'修改后的选题':'首周选题',brief:'依据已确认定位的合成选题建议',day:'2026-09-21'}, {id:'bbbbbbbb-2222-4222-8222-222222222222',platform:'x',account:'proposed-account',title:'第二个账号选题',brief:'建议账号，并未注册外部账号',day:'2026-09-22'}];
            content='【选题合成回复，仅验证流程】已读取正式定位与选题方法。'+(revision?'已按本轮要求修改。':'先给出可核对的候选。')+'\n```json\n'+JSON.stringify(rows)+'\n```';
          }
