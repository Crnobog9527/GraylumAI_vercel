-- Migration: payment fulfillment atomicity and credit idempotency
-- Description: Adds idempotency support for credit transactions and moves Stripe fulfillment into database transactions

ALTER TABLE credit_transactions
  ADD COLUMN IF NOT EXISTS idempotency_key TEXT;

CREATE UNIQUE INDEX IF NOT EXISTS idx_credit_transactions_user_idempotency_key
