...
>(({ className, ...props }, ref) => (
  <tfoot
    ref={ref}
    className={cn(
      "border-t bg-[var(--bg-tertiary)] font-medium [&>tr]:last:border-b-0",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      "border-b border-[var(--border-primary)] transition-colors hover:bg-[var(--bg-tertiary)] data-[state=selected]:bg-[var(--bg-tertiary)]",
      className
    )}
    {...props}
  />
